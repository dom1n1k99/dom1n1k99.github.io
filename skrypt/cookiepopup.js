...
function cookiePopupBox() {
  if (!getCookie('cookiePopupDismiss')) {
    document.body.innerHTML += '<div class="cookiePopupBoxContainer" id="cookiePopupBoxContainer"><div class="cookieTitle"><p>' + cookiePopupTitle + '</p></div><div class="cookieDesc"><p>' + cookiePopupDesc + ' ' + cookiePopupLink + '</p></div><div class="cookieButton"><a onClick="cookiePopupDismiss();" href="#">' + cookiePopupButton + '</a></div></div>';
